...
const quizData = [
  ...
  },
  {
    ...
    questions: [
      ...
      {
        question:
          "Which keyword is used to import a module in Node.js (CommonJS)?",
        options: ["import", "require", "include", "use"],
        answer: ["require"],
      },
      {
        question:
          "Which built-in module is used to work with the file system in Node.js?",
        options: ["http", "fs", "os", "events"],
        answer: ["fs"],
      },
      {
        question:
          "Which file is commonly used to store project metadata in Node.js?",
      ...
      {
        question:
          "Which method is used to output data to the console in Node.js?",
        options: [
          "console.write()",
          "print()",
          "console.log()",
      ...
      {
        question:
          "Which module is used to create and work with streams in Node.js?",
...
chooseTopicPage.innerHTML = quizTopic
  .map((topic) => {
    return `
...
function quizStart(currentTopic) {
  ...
  <div class="quizContent-content">
    ...
    <h1 class="quiz-question">${
      quizData[currentTopic].questions[currentQuestion].question
    }</h1>
    <div class="quiz-options">
      ${quizData[currentTopic].questions[currentQuestion].options
        .map((op, index) => {
          return `
        <label>
        <input type="checkbox" class="anwser-input" name="q${
          currentQuestion + 1
        }" value="${op}"  />
      ${op}
      </label> 
...
function handleAnswers() {
  ...
  console.log(
    `Question ${currentQuestion + 1}: Selected answer index ${SelectedAnswer}`
  );
}
